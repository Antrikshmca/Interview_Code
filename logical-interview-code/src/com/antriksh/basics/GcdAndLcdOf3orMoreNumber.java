...
class GcdAndLcdOf3orMoreNumber {
	...
	// This function called by lcdOfArray for every array element and returning
	// a result
	private static long lcd(long a, long b) {
		return a * b / (gcd(a, b));
	}

	// This function called by gcdOfArray for every array element and returning
	// a result
